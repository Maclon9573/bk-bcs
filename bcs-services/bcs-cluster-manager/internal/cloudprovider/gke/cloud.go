...
func (c *CloudInfoManager) SyncClusterCloudInfo(cls *cmproto.Cluster,
	...
	// get cloud cluster
	cluster, err := getCloudCluster(opt, cls)
	if err != nil {
...
func getCloudCluster(opt *cloudprovider.SyncClusterCloudInfoOption, cls *cmproto.Cluster) (
	*container.Cluster, error) {
	...
	cluster, err := cli.GetCluster(context.Background(), cls.ClusterName)
	if err != nil {
