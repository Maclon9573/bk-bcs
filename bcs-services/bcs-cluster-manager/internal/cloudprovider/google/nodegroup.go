...
func (ng *NodeGroup) RemoveNodesFromGroup(nodes []*proto.Node, group *proto.NodeGroup,
	...
	igmInfo, err := api.GetResourceInfo(group.AutoScaling.AutoScalingID)
	if err != nil {
...
func (ng *NodeGroup) UpdateDesiredNodes(desired uint32, group *proto.NodeGroup,
	...
	if err != nil {
		blog.Errorf("cloudprovider get all Nodes for NodeGroup %s failed, %s", group.NodeGroupID, err.Error())
		return nil, err
	}
