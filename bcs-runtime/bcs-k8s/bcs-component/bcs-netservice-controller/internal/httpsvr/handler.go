...
//func (c *HttpServerClient) getUnexpiredFixedIP(claimKey, expired string, netIPReq *NetIPAllocateRequest,
//	availableFixedIP []*v1.BCSNetIP) (*v1.BCSNetIP, error) {
//	if claimKey != "" {
//		for _, ip := range availableFixedIP {
//			if ip.Status.IPClaimKey == claimKey {
//				if err := c.updateIPStatus(ip, netIPReq, claimKey, expired, true); err != nil {
//					return nil, err
//				}
//				return ip, nil
//			}
...
//			if err := c.updateIPStatus(ip, netIPReq, "", expired, true); err != nil {
//				return nil, err
//			}
//			return ip, nil
//		}
